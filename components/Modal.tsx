import { PauseIcon, PlusIcon, ThumbUpIcon, VolumeOffIcon, VolumeUpIcon, XIcon } from '@heroicons/react/outline';
                ...
                <div className="relative pt-[56.25%]">
                    ...
                    <div className="absolute bottom-10 flex w-full items-center justify-between px-10">
                        <div className="flex space-x-3">
                            <button onClick={() => setPlaying(!playing)} className="flex items-center gap-x-2 rounded bg-white px-8 text-xl font-bold text-black transition hover:bg-[#e6e6e6]">
                                {!playing ? (<FaPlay className="h-7 w-7 text-black" />) : (<PauseIcon className="h-7 w-7 " />)}
                                {!playing ? 'Play' : 'Pause'}
                            </button>
